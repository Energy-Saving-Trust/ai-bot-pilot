...
class ChatReadRetrieveReadApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
        ...
        If asked a clarification question such as "What does this mean?" and this is the first question, respond by asking what the user wants to know the meaning of. Otherwise, explain your previous reponse in more detail. 

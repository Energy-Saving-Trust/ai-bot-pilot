...
class RetrieveThenReadApproach(Approach):
    ...
    system_chat_template = (
        "You are an intelligent Assistant helping Housing Association staff with their energy efficiency optimisation questions, and questions about the questions about the technical background of suggested measures. "
